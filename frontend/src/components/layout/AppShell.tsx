      ...
      <header className="h-12 flex-shrink-0 flex items-center justify-between px-2 sm:px-4 border-b border-surface-200 dark:border-surface-700 bg-white dark:bg-surface-900">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <button
            ...
            className="p-2 sm:p-1.5 rounded-lg hover:bg-surface-100 dark:hover:bg-surface-800 text-surface-500 hover:text-amber-500 transition-colors"
          ...
          <button
            ...
            className="p-2 sm:p-1.5 rounded-lg hover:bg-surface-100 dark:hover:bg-surface-800 text-surface-500 hover:text-violet-500 transition-colors"
            title="Code Snippets"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <button
            ...
            className="p-2 sm:p-1.5 rounded-lg hover:bg-surface-100 dark:hover:bg-surface-800 text-surface-500 hover:text-cyan-500 transition-colors"
          ...
          <button
            ...
            className="p-2 sm:p-1.5 rounded-lg hover:bg-surface-100 dark:hover:bg-surface-800 text-surface-500 hover:text-pink-500 transition-colors"
          ...
          <button
            ...
            className="p-2 sm:p-1.5 rounded-lg hover:bg-surface-100 dark:hover:bg-surface-800 text-surface-500 hover:text-surface-700 dark:hover:text-surface-300 transition-colors"
            title="Settings"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
